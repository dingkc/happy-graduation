...
public class BusinessException extends Exception {
	...
	public static void throwBusinessException(ErrorCode errorCode, String... message) throws BusinessException {
	...
	public static void throwBusinessException(String message, Throwable cause) throws BusinessException {
		throw new BusinessException(message, cause);
	}
	
	public static void throwBusinessException(Throwable cause) throws BusinessException {
